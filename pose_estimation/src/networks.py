...
from pose_estimation.src.network_mobilenet import MobilenetNetwork
from pose_estimation.src.network_mobilenet_thin import MobilenetNetworkThin

from pose_estimation.src.network_cmu import CmuNetwork
